...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    //get the tasks
    axios.get('current_tasks').then(function (res) {
...
window.axios = (axios__WEBPACK_IMPORTED_MODULE_0___default()); // Register Vue Components

Vue.component('example-component', __webpack_require__(/*! ./components/ExampleComponent.vue */ "./resources/js/components/ExampleComponent.vue").default); // Initialize Vue
    ...
    [
      _c("div", [
        _c("input", {
          ...
          domProps: { value: _vm.inp },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.inp = $event.target.value
            }
          }
        }),
        _vm._v(" "),
